...
CREATE TABLE `book` (
  ...
  `grade` int DEFAULT NULL COMMENT '학년 (1~4)',
  `semester` int DEFAULT NULL COMMENT '학기 (1~2)',
  PRIMARY KEY (`book_id`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `book_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
-- 전자공학과 도서
INSERT INTO `book` VALUES (1,1,'임헌찬 외 2인','북두출판사','전자공학과',2024,1,1);
INSERT INTO `book` VALUES (2,2,'한학근','문운당','전자공학과',2016,2,1);
INSERT INTO `book` VALUES (3,3,'한학근','동일출판사','전자공학과',2018,NULL,NULL);
INSERT INTO `book` VALUES (10,10,'하정우','북두출판사','전자공학과',2024,1,1);
INSERT INTO `book` VALUES (11,11,'오종오, 김승겸','북두출판사','전자공학과',2015,3,1);
INSERT INTO `book` VALUES (12,12,'임석구, 홍경호','한빛아카데미','전자공학과',2022,2,1);
INSERT INTO `book` VALUES (23,29,'오종오','사이버북스','전자공학과',2015,3,2);
INSERT INTO `book` VALUES (25,31,'홍순관','한빛아카데미','전자공학과',2016,1,2);
INSERT INTO `book` VALUES (41,47,'천인국','생능출판사','전자공학과',2023,4,1);
INSERT INTO `book` VALUES (9,9,'천인국','생능출판사','전자공학과',2023,4,1);

-- 정보통신과 도서
INSERT INTO `book` VALUES (4,4,'김경희 외 1인','한빛아카데미','정보통신과',2021,1,1);
INSERT INTO `book` VALUES (5,5,'김수원 외 7인','홍릉과학출판사','정보통신과',2017,2,2);
INSERT INTO `book` VALUES (6,6,'이종원','한빛아카데미','정보통신과',2017,2,1);
INSERT INTO `book` VALUES (13,13,'김종현','생능출판','정보통신과',2024,2,1);
INSERT INTO `book` VALUES (14,14,'우재남','한빛아카데미','정보통신과',2022,1,2);
INSERT INTO `book` VALUES (15,15,'이해선','북두출판사','정보통신과',2023,2,2);
INSERT INTO `book` VALUES (24,30,'김종오 외 3명','북두출판사','정보통신과',2019,2,2);
INSERT INTO `book` VALUES (26,32,'김정섭 외 2명','한빛아카데미','정보통신과',2021,1,1);
INSERT INTO `book` VALUES (27,33,'고응남','한빛아카데미','정보통신과',2020,NULL,NULL);
INSERT INTO `book` VALUES (28,34,'장문철','앤써북','정보통신과',2024,3,1);
INSERT INTO `book` VALUES (29,35,'신동진','피안피북','정보통신과',2024,3,2);

-- 전기과 도서
INSERT INTO `book` VALUES (7,7,'검정연구회','동일출판사','전기과',2024,1,1);
INSERT INTO `book` VALUES (8,8,'손혜영','인피니티북스','전기과',2016,2,2);
INSERT INTO `book` VALUES (16,16,'이충식 외 4명','동일출판사','전기과',2010,1,1);
INSERT INTO `book` VALUES (17,17,'검정연구회','동일출판사','전기과',2025,3,1);
INSERT INTO `book` VALUES (18,18,'김세동 외 3명','동일출판사','전기과',2025,3,2);
INSERT INTO `book` VALUES (30,36,'김동명','한빛아카데미','전기과',2020,2,1);
INSERT INTO `book` VALUES (31,37,'임석구, 홍경호','한빛아카데미','전기과',2016,NULL,NULL);
INSERT INTO `book` VALUES (32,38,'고재원 외 2명','동일출판사','전기과',2014,NULL,NULL);
INSERT INTO `book` VALUES (33,39,'최승덕','북두출판사','전기과',2023,1,2);
INSERT INTO `book` VALUES (34,40,'장현오','인피니티북스','전기과',2014,NULL,NULL);
INSERT INTO `book` VALUES (35,41,'검정연구회','동일출판사','전기과',2025,4,1);
INSERT INTO `book` VALUES (36,42,'김상원 외 2명','일진사','전기과',2019,2,2);

-- 치기공과 도서
INSERT INTO `book` VALUES (19,19,'권순석 외','현문사','치기공과',2025,1,1);
INSERT INTO `book` VALUES (20,20,'김기백 외','지성출판사','치기공과',2018,1,1);
INSERT INTO `book` VALUES (21,21,'관교의치기공학교육연구회','대학서림','치기공과',2022,2,2);
INSERT INTO `book` VALUES (22,22,'총의치기공학연구회','고문사','치기공과',2024,3,1);
INSERT INTO `book` VALUES (37,43,'권순석, 권은자','지성출판사','치기공과',2022,1,2);
INSERT INTO `book` VALUES (38,44,'치기공재료학연구회','고문사','치기공과',2024,2,1);
INSERT INTO `book` VALUES (39,45,'국소의치기공학연구회','지성출판사','치기공과',2022,3,2);
INSERT INTO `book` VALUES (40,46,'충의치기공학교수철의회','대학서림','치기공과',2021,4,1);

-- 컴퓨터소프트웨어과 도서
INSERT INTO `book` VALUES (42,48,'우재남, 최민아','한빛아카데미','컴퓨터소프트웨어과',2021,1,1);
INSERT INTO `book` VALUES (43,49,'민지영, 문수민 외','길벗','컴퓨터소프트웨어과',2025,1,2);
INSERT INTO `book` VALUES (44,50,'강환수 외','인피니티북스','컴퓨터소프트웨어과',2022,1,1);
INSERT INTO `book` VALUES (45,51,'황기태','생능출판사','컴퓨터소프트웨어과',2022,2,1);
INSERT INTO `book` VALUES (46,52,'천정아','연두에디션','컴퓨터소프트웨어과',2022,1,2);
INSERT INTO `book` VALUES (47,53,'오세종','한빛아카데미','컴퓨터소프트웨어과',2025,4,2);
INSERT INTO `book` VALUES (48,54,'송미영','한빛아카데미','컴퓨터소프트웨어과',2023,3,2);
INSERT INTO `book` VALUES (49,55,'황기태, 김효수','생능출판사','컴퓨터소프트웨어과',2018,3,1);
INSERT INTO `book` VALUES (50,56,'최영규, 천인국','생능출판사','컴퓨터소프트웨어과',2024,2,2);
INSERT INTO `book` VALUES (51,57,'박우창, 남송휘','한빛아카데미','컴퓨터소프트웨어과',2021,2,1);
INSERT INTO `book` VALUES (52,58,'이종원','한빛아카데미','컴퓨터소프트웨어과',2022,NULL,NULL);
INSERT INTO `book` VALUES (53,59,'장용식 외','인피니티북스','컴퓨터소프트웨어과',2019,NULL,NULL);
INSERT INTO `book` VALUES (54,60,'허원실','한빛아카데미','컴퓨터소프트웨어과',2015,3,1);
INSERT INTO `book` VALUES (55,61,'이고잉','위키북스','컴퓨터소프트웨어과',2023,4,1);
INSERT INTO `book` VALUES (56,62,'최성철','한빛아카데미','컴퓨터소프트웨어과',2022,NULL,NULL);
INSERT INTO `book` VALUES (57,63,'송미영','길벗캠퍼스','컴퓨터소프트웨어과',2024,4,1);
INSERT INTO `book` VALUES (58,64,'히로시 유키 외 3명','인피니티북스','컴퓨터소프트웨어과',2017,4,2);
INSERT INTO `book` VALUES (59,65,'길벗알앤디','길벗','컴퓨터소프트웨어과',2023,4,2);
INSERT INTO `book` VALUES (60,66,'오일석','한빛아카데미','컴퓨터소프트웨어과',2023,4,2);
